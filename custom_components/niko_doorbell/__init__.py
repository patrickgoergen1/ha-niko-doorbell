...
from .api import NikoDoorbellApiClient
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """Set up Niko Doorbell from a config entry."""
    ...
    coordinator = NikoDoorbellCoordinator(hass, entry, client)
